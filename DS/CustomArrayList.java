...
public class CustomArrayList<E> {
	...
	public void add(int index, E element) {
		...
		System.arraycopy(customArrayListElementData, index,
				customArrayListElementData, index + 1, size - index);
	...
	public E remove(int index) {
		...
		if (removeNumber > 0) {
			...
			System.arraycopy(customArrayListElementData, index + 1,
					customArrayListElementData, index, removeNumber);
	...
	private void growCustomArrayList(int minCapacity) {
		...
		customArrayListElementData = Arrays.copyOf(customArrayListElementData,
				newCapacity);
	...
	/**
	 * 
	 * main method to test the custom array list
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("strList index 0 :  " + strList.get(0));
